...
\def\xpMichelinFr{
\makexp{
post=Stagiaire de recherche en IA,
company=Michelin,
...
% Après une formation à la tomographie par rayons X, j'ai réalisé un état de l'art sur la réduction des artefacts métalliques par \textit{deep learning}. J'ai constitué une base de données synthétique d'images tomographiques de pneumatiques. J'ai réalisé un benchmark de modèles les plus prometteurs proposant une approche supervisée et une approche non supervisée.
\textit{Réduction d'artefacts métalliques sur les images tomographiques de pneumatiques par Deep Learning}\par
Après une formation à la tomographie par rayons X, j'ai réalisé un état de l'art sur la réduction des artefacts métalliques par \textit{deep learning}. J'ai constitué une base de données synthétique d'images tomographiques de pneumatiques. J'ai réalisé un benchmark des modèles les plus prometteurs, incluant une approche supervisée et une approche non supervisée.
% \begin{itemize}
...
%     \item Modèles de diﬀusion
% \end{itemize}
}}}

\def\xpMichelinEn{
\makexp{
post=AI Research Internship,
company=Michelin,
location=Clermont-Ferrand,
duration=May 2025 – Nov 2025,
desc={
% \textit{Reduction of metal artifacts in tire tomographic images using Deep Learning}\par
% After a quick learning on X-ray tomography, I conducted a literature review on metal artifact reduction using deep learning techniques. I built a synthetic tomographic image database of pneumatics. I made a benchmark of most promising models based on supervised and unsupervised learning.
\textit{Reduction of metal artifacts in tire tomographic images using Deep Learning}\par
After a quick introduction to X-ray tomography, I conducted a literature review on metal artifact reduction using deep learning techniques. I built a synthetic tomographic image database of tires. I performed a benchmark of the most promising models, including supervised and unsupervised approaches.
% % \begin{itemize}
...
\def\xpEdfFr{
\makexp{
post=Stagiaire en Data Science,
company=EDF,
location=Grenoble,
...
\textit{Classification des défaillances de turbines}\par
J'ai annoté des données textuelles liées aux défaillances de turbines, conçu un guide méthodologique pour l'annotation et affiné le modèle de langage \textit{CamemBERT} pour cette tâche spécifique.
